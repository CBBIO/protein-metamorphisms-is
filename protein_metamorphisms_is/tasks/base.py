...
- **Configuration Handling**: Loads and processes configuration constants from YAML files to ensure
that all tasks are initialized with the correct settings.
- **Extensibility**: Abstract methods are provided to allow developers to define specific task logic
for their bioinformatics workflows.
