...
.. autoclass:: protein_metamorphisms_is.information_system.uniprot.UniProtExtractor
   :members:
   :undoc-members:
   :show-inheritance:
...
- :class:`~protein_metamorphisms_is.sql.model.Protein`: Unique identifiers for protein records in UniProt.
- :class:`~protein_metamorphisms_is.sql.model.Protein`: Stores detailed protein information.
- :class:`~protein_metamorphisms_is.sql.model.PDBReference`: Manages references to Protein Data Bank entries.
- :class:`~protein_metamorphisms_is.sql.model.UniprotChains`: Handles protein chain information linked to PDB entries.
- :class:`~protein_metamorphisms_is.sql.model.GOTerm`: Stores Gene Ontology terms associated with proteins.
