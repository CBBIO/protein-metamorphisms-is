...
.. autoclass:: protein_data_handler.information_system.pdb.PDBExtractor
   :members:
   :undoc-members:
   :show-inheritance:
...
- :class:`~protein_data_handler.sql.model.PDBChains`: Represents individual chains within a protein structure in the PDB.
